      ...
      <br/>
       ...
       <div className='find-main-container' style={{ backgroundColor: "white", boxShadow: "-1px 2px 2px 2px grey",position:"absolute",zIndex:999 }}>
        <div className='find-container'>
          <span style={{borderTop:data==='hotel'?'2px solid red':'none',width:"55px",borderRight:"1px solid grey"}}>
          ...
          <span style={{ borderTop:data==='car'?'2px solid red':'none',width:"55px",borderRight:"1px solid grey" }}>
            <div onClick={()=>setData('car')} >
              <FaCar style={{fontSize: "25px",color:data==='car'?'red':'grey'}} />
              <p style={{color:data==='car'?'red':'grey'}}>Locum</p>
            </div>
          </span>
        </div>
          {
